...
const Header = () => {
  ...
  return (
      <header className="bg-white shadow-sm fixed top-0 w-screen z-30 left-0">
        ...
        <nav className="mx-auto relative flex max-w-full items-center justify-between p-4 lg:px-8 lg:py-2  lg:fixed lg:h-max shadow-md top-0 left-0 lg:w-screen lg:bg-white z-20" aria-label="Global">
                    ...
                    {products.map((item) => (
                      ...
                      >
                        ...
                        <div className="flex-auto">
                          <NavLink onClick={navClose_handler} to={item.to} className="block font-semibold text-gray-900">
                            {item.name}
